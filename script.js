...
btn.addEventListener("click", () => {
  let reset = prompt("Please pick a number between 0 and 100", "16"); // returns the number from the prompt as "z" NOW didn't safegaurd against it being an actual number
  makeGrid(reset); //creates a grid with the number from Z
});
